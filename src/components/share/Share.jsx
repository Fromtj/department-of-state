...
export default function Share() {
    ...
    <section className='bg-[#0A3553] w-[100%] pt-[40px] pb-[20px]'>
        <div className='max-w-[400px] sm:max-w-[1230px] m-auto'>
            <h1 className='text-white font-[classic] text-[30px] mb-[30px]'>Discover more on <span className='underline'>ShareAmerica:</span></h1>
            <section className='block sm:flex justify-between gap-[20px] mb-[25px]'>
                <div className='flex items-start gap-[30px] border-r-[1px] border-r-[#0A3553] sm:border-r-gray-500 w-full sm:w-[30%] py-[25px] sm:py-[0px] border-b-gray-500 border-b-[1px] sm:border-b-[#0A3553]'>
                ...
                <div className='flex items-start gap-[30px] border-r-[1px] border-r-[#0A3553] sm:border-r-gray-500 w-full sm:w-[30%] py-[15px] sm:py-[0px]'>
